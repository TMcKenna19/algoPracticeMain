// console.log the pokémon objects whose id is evenly divisible by 3 [x]
// console.log the pokémon objects that have more than one type [x]
// console.log the names of the pokémon whose only type is "poison" [x]
// console.log the first type of all the pokémon whose second type is "flying" [x]
...
function moreOneType(pokemon){
    for(var i=0; i<pokemon.length; i++){
        if(pokemon[i].types.length > 1){
        console.log("Name: " + pokemon[i].name + " Types: " + pokemon[i].types);
        }
...
function secondTypeFlying(pokemon){
    for(var i=0; i<pokemon.length; i++){
